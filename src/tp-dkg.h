...
/** @struct TP_DKG_TPState
    ...
    @var TP_DKG_PeerState:suspicious This field contains a list of
         peer indexes that have either been complained about or have
         complained but uppon closer inspection everything was
         correct. Use this info to warn the user about potentially
         misbehaving peers.
 */
typedef struct {
  int step;
